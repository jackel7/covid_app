class CountriesListModel {
  ...
  // CHANGED TO num? TO AVOID DOUBLE/INT ERRORS
  ...
  CountriesListModel.fromJson(Map<String, dynamic> json) {
    ...
    // USE .toDouble() OR .toInt() IF YOU WANT SPECIFIC TYPES,
    // BUT num HANDLES BOTH AUTOMATICALLY
...
class CountryInfo {
  ...
  String? iso2;
  String? iso3;
  // CHANGED TO num? BECAUSE COORDINATES ARE OFTEN DOUBLES
  num? lat;
  num? long;
  String? flag;
